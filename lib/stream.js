...
exports.cube2colorHTML = cube2colorHTML;
...
function Stream(buffer, offset) {
	...
	this.getFloat = function () {
		throw new Error('Stream.getFloat is unimplemented');
	}
	this.putFloat = function (num) {
		throw new Error('Stream.putFloat is unimplemented');
	}
	this.put = function (buf, size) {
		throw new Error('Stream.put is unimplemented');
	}
	this.remaining = function () {
		return this.buffer.length-this.offset;
	}
	this.overread = function () {
		return this.buffer.length<=this.offset;
	}
...
/*function printHex(str) {
	...
	for (var i = 0; i < str.length; i++) {
		process.stdout.write(' ' + str[i].charCodeAt());
	}
	process.stdout.write('\n');
}

var st = "fü\f1hren";
var uc = filterString(st);
printHex(st);
printHex(uc);*/
